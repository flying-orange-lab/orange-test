...
export class AppComponent implements OnInit {
  ...
  // TODO: 4.2 버전 실제 URL로 변경 필요
  updateUrl = 'https://alternative-wiki-4-2.vercel.app/alternative'; // 임시 URL
  ...
  ngOnInit(): void {
    // 4.2 업데이트 팝업 표시 여부 확인
    const isUpdateClosed = localStorage.getItem('hideUpdatePopup_4_2');
    if (!isUpdateClosed) {
  ...
  closeUpdatePopup() {
    ...
    localStorage.setItem('hideUpdatePopup_4_2', 'true');
  }
